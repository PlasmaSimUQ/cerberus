...
ref_nu_p = 12*(math.pi)^(3./2.)*ep_0_dim*ep_0_dim*math.sqrt(ref_mass)*(kb*ref_T)^(3./2.)/(10*(q_ref)^(4)*ref_density/ref_mass)
ref_nu_p = 1/ref_nu_p
...
v_plate = 1e-3
n0_nd = 1.0; Bx0_nd = 1.0; By0_nd = 0.0; Bz0_nd = 0; T0_nd = 1.0; 
print('\nBx0_nd = ', Bx0_nd)
