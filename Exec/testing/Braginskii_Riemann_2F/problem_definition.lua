...
states = {
  ...
  ion = {
    ...
    value = {
      rho = function(dat)
        return step(rho0, rho1, dat['x'])
      end,
      x_vel = function(dat)
        return step(u0, u1, dat['x'])
      end,
      y_vel = function(dat)
        return step(v0, v1, dat['x'])
      end,
      z_vel = function(dat)
        return step(w0, w1, dat['x'])
      end,
      p = function(dat)
        return step(p0, p1, dat['x'])
      end,
    },
  },
  ...
  electron = {
    ...
    value = {
      rho = function(dat)
        return step(rho0 / mass_ratio, rho1 / mass_ratio, dat['x'])
      end,
      x_vel = function(dat)
        return step(u0, u1, dat['x'])
      end,
  ...
  field = {
    ...
    value = {
      x_B = function(dat)
        return step(Bx0, Bx1, dat['x'])
      end,
      y_B = function(dat)
        return step(By0, By1, dat['x'])
      end,
      z_B = function(dat)
        return step(Bz0, Bz1, dat['x'])
      end,
    },
