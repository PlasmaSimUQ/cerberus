...
int norm_vel_bc[] = {BCType::int_dir,
                     BCType::foextrap,
                     BCType::foextrap,
                     BCType::reflect_odd,
                     BCType::reflect_odd,
...
int tang_vel_bc[] = {BCType::int_dir,
                     BCType::foextrap,
                     BCType::foextrap,
                     BCType::reflect_even,
                     BCType::reflect_even,
...
int norm_D_field_bc[] = {
  BCType::int_dir, BCType::foextrap, BCType::foextrap, BCType::reflect_odd, BCType::reflect_even};

int tang_D_field_bc[] = {
  BCType::int_dir, BCType::foextrap, BCType::foextrap, BCType::reflect_even, BCType::reflect_odd};
