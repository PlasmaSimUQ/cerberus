...
ARRAY_QUALIFIER P8d_agregate_coeffs[24] = {
  15.0 / 128,  0,           -21.0 / 128,  0,           -35.0 / 128,  0,
  105.0 / 128, 64.0 / 128,  // -1 -> 0
  0,           105.0 / 128, -315.0 / 128, 420.0 / 128, -315.0 / 128, 0,
  105.0 / 128, 64.0 / 128,  // 0->1
  -15.0 / 128, 105.0 / 128, -147.0 / 64,  +105.0 / 32, -35.0 / 16,   0,
  0,           +1  // 1-2
};

// Integral coefficients (with extra constant so continuous)
ARRAY_QUALIFIER P8I_coeffs[40] = {
  5.0 / 3072, 15.0 / 1024,  7.0 / 128, 7.0 / 64,  7.0 / 64,  0, 0,          1.0 / 2,
  1,          7.0 / 12,  // -2 -> 1
  -5. / 3072, 15. / 1024,   1. / 16,   7. / 64,   35. / 256, 0, -35. / 128, 0,
  337. / 512, 1.0 / 2,  // -1->0
  -5. / 3072, -15. / 1024,  1. / 16,   -7. / 64,  35. / 256, 0, -35. / 128, 0,
  337. / 512, 1.0 / 2,  // 0->1
  5.0 / 3072, -15.0 / 1024, 7.0 / 128, -7.0 / 64, 7.0 / 64,  0, 0,          -1.0 / 2,
...
FUNC_QUALIFIER W1(Real x) { return P<Real, 8, -2, 2>(x, P8_coeffs); }

FUNC_QUALIFIER W(Real x, Real y, Real z) { return W1(x) * W1(y) * W1(z); }

FUNC_QUALIFIER W1d(Real x) { return P<Real, 7, -2, 2>(x, P8d_coeffs); }
...
FUNC_QUALIFIER Wp(Real x) { return P<Real, 7, -1, 2>(x, P8d_agregate_coeffs); }
...
FUNC_QUALIFIER I_W1(Real a, Real b) { return IH_W1(b) - IH_W1(a); }
...
FUNC_QUALIFIER I_Wp(Real a, Real b) { return IH_wp(b) - IH_wp(a); }
    #endif
