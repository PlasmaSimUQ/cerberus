...
bool UserDefined::registered =
  GetActionFactory().Register(UserDefined::tag, ActionBuilder<UserDefined>);
...
{
    BL_PROFILE("UserDefined::UserDefined");
...
void UserDefined::calc_time_derivative(MFP* mfp,
