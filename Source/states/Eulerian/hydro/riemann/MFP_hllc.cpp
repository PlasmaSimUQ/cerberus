...
bool HydroHLLC::registered =
  GetHydroRiemannSolverFactory().Register(HydroHLLC::tag, HydroRiemannSolverBuilder<HydroHLLC>);

HydroHLLC::HydroHLLC() {}
HydroHLLC::HydroHLLC(const sol::table& def)
{
    BL_PROFILE("HydroHLLC::HydroHLLC");
...
void HydroHLLC::solve(Vector<Real>& L, Vector<Real>& R, Vector<Real>& F, Real* shk)
{
