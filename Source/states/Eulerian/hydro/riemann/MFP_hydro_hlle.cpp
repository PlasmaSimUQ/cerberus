...
bool HydroHLLE::registered =
  GetHydroRiemannSolverFactory().Register(HydroHLLE::tag, HydroRiemannSolverBuilder<HydroHLLE>);

HydroHLLE::HydroHLLE() {}
HydroHLLE::HydroHLLE(const sol::table& def)
{
    BL_PROFILE("HydroHLLE::HydroHLLE");
...
void HydroHLLE::solve(Vector<Real>& L, Vector<Real>& R, Vector<Real>& F, Real* shk)
{
