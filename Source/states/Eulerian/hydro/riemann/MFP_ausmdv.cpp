...
bool HydroAUSMDV::registered =
  GetHydroRiemannSolverFactory().Register(HydroAUSMDV::tag, HydroRiemannSolverBuilder<HydroAUSMDV>);

HydroAUSMDV::HydroAUSMDV() {}
HydroAUSMDV::HydroAUSMDV(const sol::table& def)
{
    BL_PROFILE("HydroAUSMDV::HydroAUSMDV");
...
void HydroAUSMDV::solve(Vector<Real>& L, Vector<Real>& R, Vector<Real>& F, Real* shk)
{
