...
bool HydroGradientRefinement::registered = GetHydroRefinementFactory().Register(
  HydroGradientRefinement::tag, HydroRefinementBuilder<HydroGradientRefinement>);
...
{
    BL_PROFILE("HydroGradientRefinement::HydroGradientRefinement");
...
{
    BL_PROFILE("HydroGradientRefinement::get_tags");
...
{
    BL_PROFILE("HydroGradientRefinement::refine_criteria");
