...
bool ThermallyPerfectGas::registered =
  GetHydroGasFactory().Register(ThermallyPerfectGas::tag, HydroGasBuilder<ThermallyPerfectGas>);
...
{
    BL_PROFILE("ThermallyPerfectGas::ThermallyPerfectGas");
...
Real ThermallyPerfectGas::get_gamma_from_cons(const Vector<Real>& U,
...
Real ThermallyPerfectGas::get_cp_from_cons(const Vector<Real>& U,
                                           const int density_idx,
                                           const int tracer_idx) const
{
...
{
    BL_PROFILE("ThermallyPerfectGas::define_rho_p_T");
...
{
    BL_PROFILE("ThermallyPerfectGas::write_info");
