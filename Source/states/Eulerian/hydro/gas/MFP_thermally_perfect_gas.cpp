...
void ThermallyPerfectGas::get_alpha_fractions_from_prim(const Vector<Real> &Q, Vector<Real> &alpha, const int tracer_idx) const
{
...
void ThermallyPerfectGas::get_alpha_fractions_from_cons(const Vector<Real> &U,
                                               Vector<Real> &alpha,
...
Real ThermallyPerfectGas::get_mass_from_prim(const Vector<Real> &Q, const int tracer_idx) const
{
    BL_PROFILE("ThermallyPerfectGas::get_mass_from_prim");
...
Real ThermallyPerfectGas::get_mass_from_cons(const Vector<Real> &U, const int density_idx, const int tracer_idx) const
{
    BL_PROFILE("ThermallyPerfectGas::get_mass_from_cons");
...
Real ThermallyPerfectGas::get_charge_from_prim(const Vector<Real> &Q, const int tracer_idx) const
{
    BL_PROFILE("ThermallyPerfectGas::get_charge_from_prim");
...
Real ThermallyPerfectGas::get_charge_from_cons(const Vector<Real> &U, const int density_idx, const int tracer_idx) const
{
    BL_PROFILE("ThermallyPerfectGas::get_charge_from_cons");
...
bool ThermallyPerfectGas::prim_valid(const Vector<Real> &Q) const
{
...
bool ThermallyPerfectGas::cons_valid(const Vector<Real> &U) const
{
...
Real ThermallyPerfectGas::get_energy_from_cons(const Vector<Real> &U) const
{
    return U[+HydroDef::ConsIdx::Eden];
}

Real ThermallyPerfectGas::get_internal_energy_density_from_cons(const Vector<Real>& U) const
{
...
Real ThermallyPerfectGas::get_temperature_from_prim(const Vector<Real> &Q) const
{
